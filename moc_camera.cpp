...
QT_MOC_LITERAL(4, 29, 27)
    ...
    "Camera\0serialNumberReady\0\0sn\0"
    "slotSerialNumberFutureReady\0"
};
...
void Camera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->serialNumberReady((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->slotSerialNumberFutureReady(); break;
        default: ;
        }
        ...
        {
            typedef void (Camera::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::serialNumberReady)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Camera::serialNumberReady(const QString & _t1)
{
